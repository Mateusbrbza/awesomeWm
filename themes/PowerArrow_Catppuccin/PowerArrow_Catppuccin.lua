--[[
    Powerarrow base theme by https://github.com/lcpz/lain
     Colours inspired from DistroTube on YouTube
...
theme.bg_focus                                  = "#89b4fa"  -- blue
theme.bg_urgent                                 = "#f38ba8"  -- red
theme.taglist_fg_focus                          = "#1e1e2e"  -- base
theme.tasklist_bg_focus                         = "#313244"  -- surface0
theme.tasklist_fg_focus                         = "#89b4fa"  -- blue
------------ BORDER ------------
theme.border_width                              = 2
theme.border_normal                             = "#313244"  -- surface0
theme.border_focus                              = "#89b4fa"  -- blue
theme.border_marked                             = "#cba6f7"  -- mauve
------------ Titlebar ------------
theme.titlebar_bg_focus                         = "#89b4fa"  -- blue
theme.titlebar_bg_normal                        = "#1e1e2e"  -- base
theme.titlebar_fg_focus                         = "#1e1e2e"  -- base
------------ Notification ------------
...
theme.weather = lain.widget.weather({
    ...
    notification_preset = { font = "JetBrains Mono 12", fg = theme.fg_normal },
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("alpha", theme.secondarycolor),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget,
                layout = wibox.layout.align.horizontal }, 2, 3), theme.secondarycolor),
            arrow(theme.secondarycolor, theme.primarycolor),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget,
                layout = wibox.layout.align.horizontal }, 3, 4), theme.primarycolor),
            arrow(theme.primarycolor, theme.secondarycolor),
            wibox.container.background(wibox.container.margin(wibox.widget { tempicon, temp.widget,
                layout = wibox.layout.align.horizontal }, 4, 4), theme.secondarycolor),
            arrow(theme.secondarycolor, theme.primarycolor),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget,
                layout = wibox.layout.align.horizontal }, 3, 3), theme.primarycolor),
            arrow(theme.primarycolor, theme.secondarycolor),
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { neticon, net.widget,
                layout = wibox.layout.align.horizontal }, 3, 3), theme.primarycolor),
            arrow(theme.primarycolor, theme.secondarycolor),
            wibox.container.background(wibox.container.margin(clock, 4, 8), theme.secondarycolor),
            arrow(theme.secondarycolor, "alpha"),
            s.mylayoutbox,
        },
    }
end
